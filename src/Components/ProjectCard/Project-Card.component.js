      ...
      <div>
        <a href={project.projectLink} target="_blank">
          <div className="double-img" id="cf">
            <img className="bottom project-img" src={project.imageLinks[0]} alt="project preview" />

            <img
              className="top project-img"
              src="https://res.cloudinary.com/dh41vh9dx/image/upload/c_scale,h_140,w_230/v1546220914/susan-sarandon.jpg"
              alt="project preview"
            />
          </div>
        </a>
